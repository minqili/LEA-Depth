...
data_path = r"/home/lmq/ZS/monodepth2/kitti_data_png"
model_weights_dir = r"/home/lmq/下载"
...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--decoder_channel_scale",
                                 ...
                                 default=100,
                                 choices=[200, 100, 50])
        # Distillation options (fair comparison)1.12添加
        self.parser.add_argument(
            "--distill_type",
            type=str,
            default="edge",
            choices=["none", "vanilla", "edge"],
            help="Distillation mode: none / vanilla / edge-aware"
        )
        self.parser.add_argument(
            "--distill_weight",
            type=float,
        ...
        self.parser.add_argument(
            ...
            type=int,
            default=0,
            help="Warm-up epochs before enabling distillation (0 = no warm-up)."
        )
        # you already added --edge_alpha, keep it
        # self.parser.add_argument("--edge_alpha", ...)
        ...
        self.parser.add_argument("--disparity_smoothness",
                                 ...
                                 default=1e-3)
        self.parser.add_argument(#xg1.11.0959
                                "--edge_alpha",
                                type=float,
                                default=1.5,
                                help="Edge weighting factor for edge-aware distillation (max edge weight = 1 + edge_alpha)")
